<div class="px-5 py-4 container-fluid">
    <div class="mt-4 row">
        <div class="col-12">
            <div class="card">
                <img src="<?= _WEB_ROOT ?>/public/assets/admin/img/header-blue-white.png" alt="pattern-lines" class="top-0 rounded-2 position-absolute start-0 w-100 h-100">
                                ...
                                <div class="modal-dialog mt-lg-10">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn bg-gradient-primary btn-sm">Tải lên</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" id="datatable-search">
                            <thead class="thead-light">
                                <tr>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Id</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Ngày Đăng</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Người Dùng</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Sản Phẩm</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Nội Dung</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Đánh Giá Sao</th>
                                    <th class="text-xxs text-center border-top-0 text-uppercase">Hành Động</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center">
                                        <span class="text-xs font-weight-bold ">{{ $comment['id'] }}</span>
                                    </td>

                                    <td class="font-weight-bold text-center">
                                        <span class="my-2 text-xs">{{ $comment['created_at'] }}</span>
                                    </td>

                                    <td class="d-flex justify-content-center">
                                        <div class="text-xs font-weight-bold  d-flex align-items-center">
                                            <img src="<?= _WEB_ROOT ?>/public/assets/admin/img/team-2.jpg" class="avatar avatar-xs rounded-circle me-2" alt="user image">
                                    ...
                                    <td class="text-xs font-weight-bold text-center">
                                        <span class="my-2 text-xs">{{ $comment['name_book'] }}</span>
                                    </td>
                                    <td class="text-xs font-weight-bold text-center">
                                        <span class="my-2 text-xs">{{ $comment['content'] }}</span>
                                    </td>

                                    <td class="text-xs font-weight-bold text-center">
                                        <span class="my-2 text-xs">{{ $comment['rating'] }}</span>
                                    </td>

                                    <td class="text-sm">
                                        <div class="d-flex justify-content-center">
                                            <a href="javascript:;" class="mx-3" data-bs-original-title="Trả lời bình luận" data-bs-toggle="modal" data-bs-target="#exampleModal{{$comment['id']}}">
                                                <i class="fas fa-user-edit text-dark"></i>
                                            </a>

                                            <a href="javascript:;" id="deleteComment" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{$comment['id']}}" data-bs-original-title="Xóa bình luận">
                                        ...
                                        <div class="modal fade" id="confirmDeleteModal{{$comment['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Dữ liệu sẽ bị xóa vĩnh viễn. Bạn có chắc chắn muốn XÓA không?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">Hủy bỏ</button>
                                                        <!-- Thêm link xóa thực sự ở đây -->
                                                        <a href="<?= _WEB_ROOT ?>comments/delete?id={{$comment['id']}}" class="btn btn-danger">Xóa</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="modal fade" id="exampleModal{{$comment['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Trả Lời Bình Luận Của <span style="color:blue;">{{$comment['user_name']}}</span></h5>
                                                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">X</span>
                                                        </button>
                                                    </div>
