...
<div class="container-fluid py-4 px-5">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
        ...
        <div class="modal-group">
            ...
            <!-- Authoration add -->
            <div class="modal fade" id="form-modal-author" tabindex="-1" role="dialog" aria-labelledby="form-modal-author" aria-hidden="true">
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        <form action="{{_WEB_ROOT}}classify/add_author" method="post" id="form-add-author">
                            <div class="modal-header">
                                <h6 class="modal-title" id="form-modal-author-title">
                                    Tác giả</h6>
                                <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
            ...
            <!-- Publication add -->
            <div class="modal fade" id="form-modal-publisher" tabindex="-1" role="dialog" aria-labelledby="form-modal-publisher" aria-hidden="true">
                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                    <div class="modal-content">
                        <form action="{{_WEB_ROOT}}classify/add_publisher" method="post" id="form-add-publisher">
                            <div class="modal-header">
                                <h6 class="modal-title" id="form-modal-publisher-title">
                                    Nhà xuất bản</h6>
                                <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" name="publication_date" placeholder="Nhập ngày xuất bản">
                                    </div>
                                    <div class="form-message"></div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-background card-background-after-none align-items-start mt-4 mb-5">
                    <div class="full-background" style="background-image: url('<?= _WEB_ROOT; ?>/public/assets/admin/img/header-blue-purple.jpg')"></div>
                    <div class="card-body text-start p-4 w-100">
                        <h3 class="text-white mb-2">Thêm sách</h3>
                        <p class="mb-4 font-weight-semibold">
                            Check all the advantages and choose the best.
                        </p>
                        <img src="<?= _WEB_ROOT; ?>/public/assets/admin/img/3d-cube.png" alt="3d-cube" class="position-absolute top-0 end-1 w-25 max-width-200 mt-n6 d-sm-block d-none" />
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="nav-tabs-wrapper">
                                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true"><i class="fa-solid fa-book-open"></i> Thông
                                                    tin</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="sku" id="sku-code" placeholder="Mã vạch sách...">
                                                                <span class="input-group-text">
                                                                    <div class="generate-sku-btn" onclick="generateSKU()">
                                                                        Tạo mã
                                                                    </div>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control" name="quantity" id="" placeholder="Số lượng sách...">
                                                            </div>
                                                            <div class="form-message"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control" name="number_pages" id="" placeholder="Số trang sách...">
                                                            </div>
                                                            <div class="form-message"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" min="1" class="form-control" name="size" id="" placeholder="Kích thước sách...">
                                                            </div>
                                                            <div class="form-message"></div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-text m-0 p-0">
                                                                    <button type="button" class="btn-input-group btn btn-block btn-dark m-0" data-bs-toggle="modal" data-bs-target="#form-modal-category">+
                                                                        Thêm
                                                                        danh mục</button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <select class="form-select" name="author" id="category">
                                                                ...
                                                                <div class="input-group-text m-0 p-0">
                                                                    <button type="button" class="btn-input-group btn btn-block btn-dark m-0" data-bs-toggle="modal" data-bs-target="#form-modal-author">+
                                                                        Thêm
                                                                        tác giả</button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-text m-0 p-0">
                                                                    <button type="button" class="btn-input-group btn btn-block btn-dark m-0" data-bs-toggle="modal" data-bs-target="#form-modal-publisher">+
                                                                        Thêm
                                                                        nhà xuất bản</button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="sale_price" class="form-control" placeholder="Nhập giảm giá...">
                                                            </div>
                                                            <div class="form-message"></div>
                                                        </div>
                                                    </div>
