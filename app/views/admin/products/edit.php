                    ...
                    <div class="col-lg-8">
                        <div class="card h-100 is-shadow">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-6 text-end">
                                        <button class="mb-0 btn btn-white me-2 btn-sm" type="button" name="button">
                                            <svg width="14" height="15" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9 2.5C8.62123 2.5 8.27497 2.714 8.10557 3.05279L7.38197 4.5H4C3.44772 4.5 3 4.94772 3 5.5C3 6.05228 3.44772 6.5 4 6.5V16.5C4 17.6046 4.89543 18.5 6 18.5H14C15.1046 18.5 16 17.6046 16 16.5V6.5C16.5523 6.5 17 6.05228 17 5.5C17 4.94772 16.5523 4.5 16 4.5H12.618L11.8944 3.05279C11.725 2.714 11.3788 2.5 11 2.5H9ZM7 8.5C7 7.94772 7.44772 7.5 8 7.5C8.55228 7.5 9 7.94772 9 8.5V14.5C9 15.0523 8.55228 15.5 8 15.5C7.44772 15.5 7 15.0523 7 14.5V8.5ZM12 7.5C11.4477 7.5 11 7.94772 11 8.5V14.5C11 15.0523 11.4477 15.5 12 15.5C12.5523 15.5 13 15.0523 13 14.5V8.5C13 7.94772 12.5523 7.5 12 7.5Z" fill="#111827" />
                                            </svg>
                                            Remove
                                        </button>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <img class="mt-3 shadow-lg w-100 border-radius-lg" src="../assets/img/spacejoy-c0JoR_-2x3E-unsplash.jpg" alt="product_image">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="pt-2 mt-4 my-gallery d-flex justify-content-between align-items-center" itemscope itemtype="http://schema.org/ImageGallery">
                                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                <a href="../assets/img/spacejoy-c0JoR_-2x3E-unsplash.jpg" itemprop="contentUrl" data-size="600x600">
                                                    <img class="shadow max-height-100 border-radius-lg" src="../assets/img/spacejoy-c0JoR_-2x3E-unsplash.jpg" alt="Image description" />
                                                </a>
                                            </figure>
                                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                <a href="../assets/img/spacejoy-Kh4tedFdHz4-unsplash.jpg" itemprop="contentUrl" data-size="600x600">
                                                    <img class="shadow max-height-100 border-radius-lg" src="../assets/img/spacejoy-Kh4tedFdHz4-unsplash.jpg" itemprop="thumbnail" alt="Image description" />
                                                </a>
                                            </figure>
                                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                <a href="../assets/img/michael-oxendine-GHCVUtBECuY-unsplash.jpg" itemprop="contentUrl" data-size="600x600">
                                                    <img class="shadow max-height-100 border-radius-lg" src="../assets/img/michael-oxendine-GHCVUtBECuY-unsplash.jpg" itemprop="thumbnail" alt="Image description" />
                                                </a>
                                            </figure>
                                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                <a href="../assets/img/spacejoy-NpF_OYE301E-unsplash.jpg" itemprop="contentUrl" data-size="600x600">
                                                    <img class="shadow max-height-100 border-radius-lg" src="../assets/img/spacejoy-NpF_OYE301E-unsplash.jpg" itemprop="thumbnail" alt="Image description" />
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
