  ...
  <div class="mt-5 mb-5 mt-lg-9 row">
    ...
    <div class="col-lg-9 col-12">
      <div class="card card-body" id="profile">
        <img src="<?= _WEB_ROOT ?>/public/assets/admin/img/header-orange-purple.jpg" alt="pattern-lines" class="top-0 rounded-2 position-absolute start-0 w-100 h-100">
    ...
    <div class="col-lg-9 col-12">
      <div class="card" id="basic-info">
        ...
        <div class="pt-0 card-body">
          <form action="<?= _WEB_ROOT . $action; ?>" method="post" id="form_edit_users">
  ...
  <div class="mb-5 row">
    ...
    <div class="col-lg-9 col-12">
      <div class="card" id="password">
        ...
        <div class="pt-0 card-body">
          <form id="form_change_pass" action="users/profile" method="post">
            <input type="hidden" value="{{$user['id']}}">
