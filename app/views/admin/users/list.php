                                    ...
                                    <tr>
                                        <td>
                                            <div class="px-2 py-1 d-flex">
                                                <div>
                                                    <img src="<?= _WEB_ROOT; ?>/public/assets/admin/img/{{$user['avatar']}}" class="avatar avatar-sm me-3"
                                                        alt="avatar image">
                                                </div>
                                        ...
                                        <td class="text-sm align-middle">
                                            <p class="mb-0 text-sm text-secondary"><a href="/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="295b404a41485b4d694a5b4c485d405f4c045d4044074a4644">{{$user['email']}}</a>
                                            </p>
                                        </td>
