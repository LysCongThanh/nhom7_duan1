    ...
    <div class="container px-2 py-1 min-w-100">
        <nav aria-label="breadcrumb">
            <ol class="px-0 pt-1 pb-0 mb-1 bg-transparent breadcrumb me-sm-6 me-5">
                <li class="text-sm breadcrumb-item"><a class="opacity-5 p-0 breadcrumb-text  text-white " href="javascript:;">Dashboard</a></li>
                <li class="text-sm breadcrumb-item  breadcrumb-text  text-white  active" aria-current="page">
                    Edit Product</li>
            </ol>
            <h6 class="mb-0 font-weight-bold breadcrumb-text  text-white ">Edit Product</h6>
        </nav>
