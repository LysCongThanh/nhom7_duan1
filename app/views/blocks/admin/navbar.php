...
<?= show_message('<div class="px-5 py-4 container-fluid"><div id="alert" class="alert bg-gradient-primary alert-dismissible text-sm  text-white  fade show" role="alert">
