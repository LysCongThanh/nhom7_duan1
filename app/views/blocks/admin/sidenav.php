<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand d-flex align-items-center m-0"
                ...
                target="_blank">
                <img class="navbar-brand-img" src="<?= _WEB_ROOT; ?>/public/assets/admin/img/logo-ct.png" alt>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#dashboardsExamples"
                        class="nav-link text-white active opacity-10" aria-controls="dashboardsExamples" role="button"
                        aria-expanded="true">
                        <div
                    ...
                    <div class="collapse  show " id="dashboardsExamples">
                        <ul class="nav border-start ms-4">
                            <li class="nav-item active">
                                <a class="nav-link text-white active opacity-10 "
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/dashboards/automotive.html">
                                    <span class="sidenav-mini-icon"> A </span>
                                    <span class="sidenav-normal"> Automotive </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/dashboards/smart-home.html">
                                    <span class="sidenav-mini-icon"> S </span>
                                    <span class="sidenav-normal"> Smart Home </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/dashboards/crm.html">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="pagesExamples">
                        <ul class="nav border-start ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/pages/sweet-alerts.html">
                                    <span class="sidenav-mini-icon"> S </span>
                                    <span class="sidenav-normal"> Sweet Alerts </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/pages/notifications.html">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="applicationsExamples">
                        <ul class="nav border-start ms-4">
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/applications/kanban.html">
                                    <span class="sidenav-mini-icon"> K </span>
                                    <span class="sidenav-normal"> Kanban </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/applications/wizard.html">
                                    <span class="sidenav-mini-icon"> W </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/applications/datatables.html">
                                    <span class="sidenav-mini-icon"> D </span>
                                    <span class="sidenav-normal"> DataTables </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/applications/calendar.html">
                                    <span class="sidenav-mini-icon"> C </span>
                                    <span class="sidenav-normal"> Calendar </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/applications/analytics.html">
                                    <span class="sidenav-mini-icon"> A </span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="ecommerceExamples">
                        <ul class="nav border-start ms-4">
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/ecommerce/overview.html">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../pages/ecommerce/referral.html">
