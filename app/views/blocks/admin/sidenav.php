<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="dashboard" target="_blank">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" href="#vrExamples">
                    ...
                    <span class="nav-link-text ms-1">Quản Lý Sách</span>
                </a>
                <div class="collapse " id="vrExamples">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item border-start my-0 pt-2">
                            <a class="nav-link position-relative ms-0 ps-2 py-2 " href="them-san-pham">
                                <span class="nav-link-text ms-1">Thêm Sách</span>
                            </a>
                        </li>
                        <li class="nav-item border-start my-0 pt-2">
                            <a class="nav-link position-relative ms-0 ps-2 py-2 " href="phan-loai">
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Người Dùng</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 " href="them-nguoi-dung">
                    <span class="nav-link-text ms-1">Thêm Người Dùng</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 " href="danh-sach-nguoi-dung">
