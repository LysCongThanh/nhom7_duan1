<div class="container">
	...
	<section class="padding-bottom">
	<header class="section-heading heading-line">
		<h4 class="title-section text-uppercase">Phổ Biến</h4>
	</header>
	...
	<section class="padding-bottom">
		...
		<header class="section-heading heading-line">
			<h4 class="title-section text-uppercase"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">BÀI VIẾT</font></font></h4>
		</header>
	...
	<section class="padding-bottom">
		...
		<header class="section-heading heading-line">
			<h4 class="title-section text-uppercase"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Chọn vùng</font></font></h4>
		</header>
	...
	<section class="section-subscribe padding-y-lg">
		...
		<p class="pb-2 text-center text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Cung cấp các xu hướng sản phẩm mới nhất và tin tức trong ngành ngay tới hộp thư đến của bạn</font></font></p>
		...
		<form class="form-row">
				...
				<button type="submit" class="btn btn-block btn-warning" fdprocessedid="yjz22i"> <i class="fa fa-envelope"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Đặt mua</font></font></button>
				</div> <!-- col.// -->
		</form>
		<small class="form-text text-white-50"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Chúng tôi sẽ không bao giờ chia sẻ địa chỉ email của bạn với bên thứ ba.</font></font></small>
			</div> <!-- col-md-6.// -->
		</div>
