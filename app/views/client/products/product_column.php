								...
								<div class="inner">
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Thiếu Nhi</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Tiểu Thuyết</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Lịch sử</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Tài Chính</font>
											</font>
										</div>
									</label>
							...
							<div class="filter-content collapse show" id="collapse_2">
								<div class="inner">
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Thanh Xuân</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Nam Hải</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-checkbox">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Quốc Trung</font>
											</font>
										</div>
									</label>
								...
								<div class="inner">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label>
												<font style="vertical-align: inherit;">
													<font style="vertical-align: inherit;">Tổi Thiểu</font>
												</font>
											</label>
											<input class="form-control" placeholder="0 đ" type="number" fdprocessedid="854m">
										</div>
										<div class="form-group text-right col-md-6">
											<label>
												<font style="vertical-align: inherit;">
													<font style="vertical-align: inherit;">Tối Đa</font>
												</font>
											</label>
											<input class="form-control" placeholder="50000 đ" type="number" fdprocessedid="ccygk8">
										</div>
									</div>
									<!-- form-row.// -->
						...
						<article class="filter-group">
							<h6 class="title">
								<a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#collapse_5">
									<font style="vertical-align: inherit;">
										<font style="vertical-align: inherit;">Tình trạng</font>
									</font>
								</a>
							</h6>
							<div class="filter-content collapse show" id="collapse_5">
								<div class="inner">
									...
									<label class="custom-control custom-radio">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Sách mới</font>
											</font>
										</div>
									</label>
									...
									<label class="custom-control custom-radio">
										...
										<div class="custom-control-label">
											<font style="vertical-align: inherit;">
												<font style="vertical-align: inherit;">Sách cũ</font>
											</font>
										</div>
									</label>
								</div>
