	...
	<div class="row">
		...
		<main class="col-md-9">
			...
			<header class="card-header">
				...
				<strong class="d-inline-block mr-3"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">ID đơn hàng: {{$order['ID']}}</font></font></strong>
				<span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ngày đặt hàng: {{$formattedDate}}</font></font></span>
			</header>
			<div class="card-body">
				<div class="row"> 
					<div class="col-md-8">
						<h6 class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Chuyển tới</font></font></h6>
						<p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$order['name_user']}}</font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">  
						Điện thoại +{{$order['tel']}} Email: {{$order['email']}} </font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
						Địa điểm: {{$order['specific_address'] . ', ' . $order['address']}} </font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 
						PO Box: 100123
						 </font></font></p>
					</div>
					<div class="col-md-4">
						...
						<p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tổng cộng:  {{number_format($order['total'])}}đ </font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
						 Phí vận chuyển: {{number_format($order['shipping_cost'])}} đ </font></font><br> 
						 <span class="b"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tổng cộng: {{number_format($order['total'] - $order['shipping_cost'])}} đ</font></font></span>
						</p>
					</div>
				</div> <!-- row.// -->
			</div> <!-- card-body .// -->
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td> 
						<p class="title mb-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$order_detail['name_book']}}</font></font></p>
